...
export function AppShell({ activeScreen, children, onLogout, onNavigate, onToggleTheme, theme, title, user }) {
  return (
    <div className="min-h-screen bg-cream text-ink lg:flex">
      ...
      <main className="min-w-0 flex-1">
        <Navbar logoutItem={appSidebar.logoutItem} onLogout={onLogout} onToggleTheme={onToggleTheme} theme={theme} title={title} user={user} {...appNavbar} />
