const cardVariants = {
  ...
  flat: 'rounded-[1.25rem] border border-line bg-cream-card p-4 shadow-soft sm:rounded-[1.5rem] sm:p-5',
  metric: 'rounded-[1.25rem] border border-line/80 bg-cream-card p-4 shadow-soft sm:rounded-[1.5rem] sm:p-5',
}
