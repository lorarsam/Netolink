export function BrandLogo({ name, ariaLabel, compact = false, iconSrc }) {
  return (
    <div className="flex items-center justify-center gap-2 text-cream-card" aria-label={ariaLabel}>
      <span className={`${compact ? 'h-5 w-5 rounded-md' : 'h-6 w-6 rounded-lg'} grid place-items-center bg-cream-card text-brand`}>
